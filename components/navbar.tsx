  ...
  <Button className="bg-primary text-primary-foreground"  >Get in Touch</Button>
      ...
      <div className="hidden md:flex items-center gap-6 ml-32 bg-green-500 rounded-bl-[50%] rounded-br-[50%] p-4">
                <nav className="flex items-center gap-6">
                    ...
                    <Link href="#services" className="text-sm font-medium hover:underline" prefetch={false}>
                        Services
                    </Link>
                    <Link href="#partners" className="text-sm font-medium hover:underline" prefetch={false}>
                        Partners
                    </Link>
        ...
        <SheetContent side="left">
          <div className="grid gap-6 p-6">
            <Link href="#" className="flex items-center gap-2" prefetch={false}>
              ...
              <span className="text-xl font-bold">Al Shard Mediation</span>
            </Link>
